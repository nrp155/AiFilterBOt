...
# Bot information
SESSION = environ.get('SESSION', 'subscenelk')
API_ID = int(environ.get('API_ID', '4399087'))
API_HASH = environ.get('API_HASH', '112023ea7546c4f071e0b195ea5996a5')
BOT_TOKEN = environ.get('BOT_TOKEN', "7850325796:AAEonUTj8Wrxa60W5iDfYBvLqOQQ1J9LejI")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1002913884 1553961614 1784032025').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002518750384'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001416144010').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002358857632')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001416144010 -1001320313655 -1001153556475')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002518750384')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://subscenelkbatch:subscenelkbatch@cluster0.bbbnzwo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://batchfile2:batchfile2@cluster2.wb6wirh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster2")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://batchfile3:batchfile3@cluster3.t0hxuhm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster3")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://batchfile4:batchfile4@cluster0.qiuxkqt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://telegra.ph/file/952b9a74cb00c7f27af74.jpg') # payment code picture url.
